function calculateNetSalary() {
    // Promption of user to input basic salary and benefits
    ...
    if (grossSalary <= 24000) {
      ...
      payee = 3000 + 0.25 * (grossSalary - 25000);
    } else {
      payee = 6000 + 0.3 * (grossSalary - 30000);
    }
  
    // Calculated NHIF deductions
    let nhifDeductions;
    if (grossSalary <= 5999) {
      nhifDeductions = 150;
    ...
    // Calculation of net salary of user
    const netSalary = grossSalary - payee - nhifDeductions - nssfDeductions;
  
    // Displaying the calculation of values to the user
